...
public class AseguradoraAdapter extends RecyclerView.Adapter<AseguradoraAdapter.ViewHolder> implements Filterable {

    private List<String> mData;
    private LayoutInflater mInflater;
    private ItemClickListener mClickListener;

    public AseguradoraAdapter(Context context, List<String> mData) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.fragment_cardview_aseguradora, parent, false);
